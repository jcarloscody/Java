package s18_Interfaces.ComInterface.App;
...
import s18_Interfaces.ComInterface.Model.Entities.Veiculo;
import s18_Interfaces.ComInterface.Model.Services.BrasilTaxaServices;
import s18_Interfaces.ComInterface.Model.Services.ServicoDeAluguel;
...
public class App {
    public static void main(String[] args) throws ParseException {
        ...
        //// injeção de dependencia por meio de construtor: uma instanciação de uma
        //// outra classe, classe esta que implementa a correpondente do paramentro.
        //// "new BrasilTaxaServices"
