package cap15_ArquivosFluxosSerializacaodeObjetos.LendoArquivo;
...
public class LendoTexto {
    ...
    public static void openFile() {
        try {
            input = new Scanner(Paths.get(".\\src\\cap15_ArquivosFluxosSerializacaodeObjetos\\EscrevendoArquivo\\clients.txt"));
